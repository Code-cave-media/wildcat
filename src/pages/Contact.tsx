    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-32 pb-16">
        <div className="container">
          ...
          >
            <span className="text-sm font-sans uppercase tracking-widest text-muted-foreground">Inquiries</span>
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">
                For general questions, partnerships, or press inquiries, reach out to our team.
              </p>
              <div className="space-y-4 text-sm font-sans">
                <p>Email: <a href="mailto:hello@wildcat.agency" className="text-primary hover:underline">hello@wildcat.agency</a></p>
            ...
            >
              <form className="space-y-6 flex flex-col" onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input type="text" className="w-full bg-transparent border-b border-foreground/20 py-2 outline-none focus:border-primary transition-colors" placeholder="Jane Doe" />
                </div>
                <div>
                  <label className="block text-xs uppercase tracking-widest text-muted-foreground mb-2">Email</label>
                  <input type="email" className="w-full bg-transparent border-b border-foreground/20 py-2 outline-none focus:border-primary transition-colors" placeholder="jane@company.com" />
                </div>
                <div>
                  <label className="block text-xs uppercase tracking-widest text-muted-foreground mb-2">Message</label>
                  <textarea rows={4} className="w-full bg-transparent border-b border-foreground/20 py-2 outline-none focus:border-primary transition-colors resize-none" placeholder="How can we help?" />
                </div>
