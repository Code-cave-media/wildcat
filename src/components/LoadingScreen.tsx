      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[60vw] h-[60vw] max-w-[500px] max-h-[500px] bg-brand-amber/20 rounded-full blur-[100px] z-[55]"
          />
          <motion.div
            initial={{ scale: 0, rotate: 0 }}
            ...
            <div className="flex flex-col items-center gap-4 w-56">
              ...
              <div className="flex justify-between w-full">
                ...
                <motion.p
                  ...
                  className="text-[10px] sm:text-xs font-mono tracking-[0.3em] uppercase text-brand-amber"
                >
                  Loading
                </motion.p>
              </div>
